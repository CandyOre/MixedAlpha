...
void run() {
    ...
    // auto agent1 = new HomoDivCustIndFunction(gen_utility_profile(goods_amount, 5, 3), 10);
    // auto agent2 = new HomoDivCustIndFunction(gen_utility_profile(goods_amount, 5, 3), 10);
    // auto agent3 = new HomoDivCustIndFunction(gen_utility_profile(goods_amount, 5, 3), 10);
    // auto agent4 = new HomoDivCustIndFunction(gen_utility_profile(goods_amount, 5, 3), 10);
